    ...
    <main id="main">
        ...
        <section class="two-one">
            ...
            <div class="two-right-right">
              <a href="#" class="add-one">Nhập địa chỉ mới</a>
              <!-- <input type="checkbox" id="toggle_sidebar"> -->
                <div id="wrapper">
                    <form action="" id="form-login">
                        <div class="form-group">
                            <i class="far fa-user"></i>
                            <input type="text" class="form-input" placeholder="Họ">
                        </div>
                        <div class="form-group">
                            <i class="far fa-user"></i>
                        ...
                        <div class="form-group">
                            <i class="fas fa-keyy"></i>
                            <input type="password" class="form-input" placeholder="Công ty">
                        </div>
                        <div class="form-group">
                            <i class="fas fa-keyy"></i>
                            <input type="password" class="form-input" placeholder="Địa chỉ 1">
                        </div>
                        <div class="form-group">
                            <i class="fas fa-keyy"></i>
                            <input type="password" class="form-input" placeholder="Địa chỉ 2">
                        </div>
                        <div class="form-group">
                            <i class="fas fa-keyyy"></i>
                            <input type="password" class="form-input" placeholder="Điện Thoại">
                        </div>
                        <div >
                            <input type="checkbox" name="" value="" /> Đặt làm địa chỉ mặc định
                        </div>
                        <div class="add-text" >
                            <a href="#" class="add-onee">Thêm mới</a>
                            <span class="kind-add">
                                Hoặc
                                <a href="#"> Hủy</a>
                            </span>
