...
$sql = "INSERT INTO donhang(madonhang,tongtien,ngaydathang,makhachhang,trangthaidonhang,phuongthucthanhtoan) values(?,?,?,?,?,?)";
$addOrder = $db->prepare($sql);
$addOrder->execute([$orderID, $_GET['total'], $_GET['day'], $_SESSION['userID'], $_GET['status'], $_GET['method']]);
